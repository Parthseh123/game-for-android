...
function preload() {
  ...
  targetImage = loadImage("../images/target10.png");
  playerImage = loadImage("../images/player10.png")
...
function setup() {
  ...
  player.scale = 0.0789;
  player.setCollider("circle",0,0,220)

  target = createSprite(1200, 100);
  target.addImage(targetImage)
  target.scale = 0.1;

  up = createSprite(1200, 470);
  up.addImage(upImage)
  up.scale = 0.05;

  down = createSprite(1200, 530);
  down.addImage(downImage)
  down.scale = 0.05;

  left = createSprite(1150, 500);
  left.addImage(leftImage)
  left.scale = 0.05;

  right = createSprite(1250, 500);
  ...
  obs25 = createSprite(830, 390, 150, 30);
  obs25.shapeColor = "red";
  obs25.velocityY = 3;

  obs26 = createSprite(1200, 350, 150, 30);
  obs26.shapeColor = "red";

  obs27 = createSprite(695, 350, 150, 30);
  obs27.shapeColor = "red";

  obs28 = createSprite(600, 350, 30, 150);
  obs28.shapeColor = "red";
  obs28.velocityY= -3;

  obs29 = createSprite(830, 390, 150, 30);
  obs29.shapeColor = "red";
  obs29.velocityY = 3;

  obs30 = createSprite(1200, 350, 150, 30);
  obs30.shapeColor = "red";

  obs31 = createSprite(695, 350, 150, 30);
  obs31.shapeColor = "red";
}
...
function draw() {
  ...
  if (obs25.isTouching(side4)) {
    obs25.bounceOff(side4)
  }

  if (obs25.isTouching(side2)) {
    obs25.bounceOff(side2)
  }


  if (obs26.isTouching(side2)) {
    obs26.bounceOff(side2)
  }


  if (obs26.isTouching(side4)) {
    obs26.bounceOff(side4)
  }

  if (obs28.isTouching(side2)) {
    obs28.bounceOff(side2)
  }


  if (obs28.isTouching(side4)) {
    obs28.bounceOff(side4)
  }
  ...
  if (player.isTouching(obs25)) {
    player.collide(obs25)
    let b = confirm("😢😭😭You Lost , Do you want to save your progress");
    console.log(b);
    player.x = 120
    player.y = 520
  ...
  if (player.isTouching(obs26)) {
    player.collide(obs26)
    let b = confirm("😢😭😭You Lost , Do you want to save your progress");
    console.log(b);
    player.x = 120
    player.y = 520
  ...
  if (player.isTouching(obs27)) {
    player.collide(obs27)
    let b = confirm("😢😭😭You Lost , Do you want to save your progress");
    console.log(b);
    player.x = 120
    player.y = 520
  ...
  if (player.isTouching(target)) {
    ...
    window.open("http://127.0.0.1:5504/home5.html", "_self");
