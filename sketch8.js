...
function preload() {
  ...
  playerImage = loadImage("/images/player8.png")
...
function draw() {
  ...
  if (player.isTouching(target)) {
    let b = confirm("You have reached target 1 try to reach target 2");
    console.log(b);
    player.x = 120;
    player.y = 520;

    target.addImage(playerImage);
  }
