...
function preload() {
  ...
  targetImage = loadImage("../images/target7.png");
  playerImage = loadImage("/images/player7.png")
...
function setup() {
  ...
  player.addImage(playerImage)
  player.scale = 0.105;
  player.setCollider("circle",0,0,190)
  ...
  obs26 = createSprite(1200, 490, 150, 30);
...
function draw() {
  ...
  if (target.isTouching(side3)) {
    target.bounceOff(side3)
  }
  if (target.isTouching(obs21)) {
    target.bounceOff(obs21)
  }
